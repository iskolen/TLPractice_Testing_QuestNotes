...
public class NotesPage {
    ...
    @FindBy(xpath = "//x-dock-panel[@class='TLUI-node']//x-panel[@class='TLUI-node']//x-icon[@class='TLUI-node']")
    private WebElement btnAction;
    @FindBy(xpath = "//x-text[contains(text(),'Редактировать')]")
    private WebElement btnEdit;
    @FindBy(xpath = "//tl-icon[@class='close-button ng-isolate-scope tlui-icon']//div[@class='icon']//*[name()='svg']")
    private WebElement btnClose;
    @FindBy(xpath = "//x-text[contains(text(),'Удалить')]")
    private WebElement btnDelete;
    @FindBy(xpath = "//button[@type='button']//span[@class='ng-binding ng-scope'][contains(text(),'Удалить')]")
    private WebElement btnDeleteAccept;
