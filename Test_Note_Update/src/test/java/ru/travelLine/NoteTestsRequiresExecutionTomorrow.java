...
public class NoteTestsRequiresExecutionTomorrow{
    ...
    public NoteTestsRequiresExecutionTomorrow(String noteText, String noteHours, String noteMinutes) {
    ...
    public static Collection<Object[]> data() {
        Object[][] data = new Object[][]{{ConfProperties.getProperty("noteTextMaxChar"), "00", "00"}, {ConfProperties.getProperty("noteTextEmptyChar"), "15", "00"}, {ConfProperties.getProperty("noteTextSpecChar"), "15", "00"}, {ConfProperties.getProperty("noteTextSpecChar"), "23", "59"}};
        return Arrays.asList(data);
    }

    @Test
    @DisplayName("This test checks the 3 case when the status is 'RequiresExecution' tomorrow and :" +
                 "1)Note text is: 'Empty value',             time is: 15:00" +
                 "3)Note text is: 'Maximum character value', time is: 0:00" +
                 "4)Note text is: 'Special characters',      time is: 15:00" +
                 "4)Note text is: 'Special characters',      time is: 23:59")
    public void testsRequiresExecutionTomorrow() throws InterruptedException {
