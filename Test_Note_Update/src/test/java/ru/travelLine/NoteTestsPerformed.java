...
public class NoteTestsPerformed {
    ...
    public NoteTestsPerformed(String noteText) {
    ...
    @Test
    @DisplayName("This test checks the 3 case when the status is 'Performed' and the note text is :" +
            "1)Maximum character value" +
            "2)Special characters" +
            "3)Empty value")
    public void testPerformed() throws InterruptedException {
        ...
        Assert.assertEquals("Статус выбран не верно!", "Выполнено", statusExam);
    }
}