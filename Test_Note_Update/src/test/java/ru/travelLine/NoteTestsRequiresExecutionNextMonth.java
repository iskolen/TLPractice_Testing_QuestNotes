...
public class NoteTestsRequiresExecutionNextMonth {
    ...
    public NoteTestsRequiresExecutionNextMonth(String noteText, String noteHours, String noteMinutes) {
    ...
    public static Collection<Object[]> data() {
        Object[][] data = new Object[][]{{ConfProperties.getProperty("noteTextMaxChar"), "15", "00"}, {ConfProperties.getProperty("noteTextSpecChar"), "00", "00"}, {ConfProperties.getProperty("noteTextEmptyChar"), "23", "59"}};
        return Arrays.asList(data);
    }

    @Test
    @DisplayName("This test checks the 3 case when the status is 'RequiresExecution' after month and :" +
                 "1)Note text is: 'Maximum character value', time is: 15:00" +
                 "2)Note text is: 'Special characters',      time is: 0:00" +
                 "3)Note text is: 'Empty value',             time is: 23:59")
    public void testsRequiresExecutionNextMonth() throws InterruptedException {
