...
public class NotesPage {
    ...
    //Select minutes
    @FindBy(xpath = "//input[@ng-model='modelViewValue.string.minutes']")
    ...
    //Select day
    @FindBy(xpath = "/html[1]/body[1]/div[3]/tl-extranet-host[1]/tl-popup[1]/div[2]/div[1]/div[1]/tl-window[1]/div[1]/tl-window-content[1]/div[1]/ng-form[1]/tl-form-item[3]/div[1]/tl-form-item-content[1]/tl-control-date[1]/div[1]/ul[1]/li[1]/div[1]/table[1]/tbody[1]/tr[4]/td[4]/button[1]")
    ...
    public void click_day_selection(){
        day_selection.click();}
